...
mkdir -p "$CASE_DIR/active/$project/reference" "$CASE_DIR/archive/reference"
write_numbered_files "$CASE_DIR/active/$project/reference" ".$(theme_field item)-" ".dat" 32 "active reference"
write_numbered_files "$CASE_DIR/archive/reference" ".$(theme_field file)-" ".dat" 24 "archive reference"
